...
<html>
  <head>
    ...
    <!-- Favicon-->
    <link rel=\"shortcut icon\" href=\"img/pcusa-color-logo.gif\" />
  </head>
  <body
      ...
      >
        <div class=\"container\">
          <a class=\"navbar-brand d-block d-lg-none ms-2 me-0\" href=\"#!\"
            ><img src=\"img/pcusa-color-logo.gif\" alt=\"...\" width=\"60\"
          /></a>
          <ul class=\"ps-0 pt-3\">
      ...
      <div class=\"swiper hero-slider\">
        <div class=\"swiper-wrapper\">
          <!-- <div
            ...
            style=\"background: url(img/hero-68153-Reflection-1920x1144.jpg)\"
          > -->
          <div
            class=\"swiper-slide hero-slide bg-cover py-5 with-border-image d-flex align-items-center\"
            style=\"background: url(img/hero-68153-Reflection-1920x1144.jpg)\"
          >
            <div class=\"container text-white py-5 my-5 index-forward\">
              ...
              <div class=\"row\">
                ...
                <div class=\"col-lg-7 mx-auto\">
                  <a class=\"btn btn-primary px-4\" href=\"#watch-online\"
                    >Watch Online</a
                  >
                </div>
              </div>
          ...
          >
            <div class=\"container text-white py-5 my-5 index-forward\">
              <h1 class=\"text-uppercase text-xl mt-5\">Way to god</h1>
              <div class=\"row\">
                <div class=\"col-lg-7 mx-auto\">
                  <p class=\"lead\">
                    Visit your local church and become a part of the flock by
                    contributing to the community in any way you possibly can.
                  </p>
                  <a class=\"btn btn-primary px-4\" href=\"text.html\">Read More</a>
                </div>
              </div>
          ...
          >
            <div class=\"container text-white py-5 my-5 index-forward\">
              <h1 class=\"text-uppercase text-xl mt-5\">God is love</h1>
              <div class=\"row\">
                <div class=\"col-lg-7 mx-auto\">
                  <p class=\"lead\">
                    Visit your local church and become a part of the flock by
      ...
      <div class=\"container-fluid px-0\">
        <div class=\"row align-items-stretch\">
          <div
            ...
            style=\"background: url(img/rice.jpg)\"
          ></div>
        ...
        <div class=\"row align-items-stretch gx-0\">
          <div class=\"col-lg-6\">
            <div
              ...
              style=\"height: 30rem; background: url(img/CambriaChurch.jpg)\"
            ></div>
          </div>
          <div class=\"col-lg-6\">
